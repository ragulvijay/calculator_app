...
def add_to_calculations(symbol):
    ...
    text_reult.delete(1.0,"end")

    text_reult.insert(1.0, calculation)
...
text_reult=tk.Text(root, height=2, width=17, font=("Arial",24))
text_reult.grid(columnspan=5)
...
btn_sub=tk.Button(root, text="-", command=lambda: add_to_calculations("-"),width=5, font=("Arial",14))
...
btn_dot=tk.Button(root, text=".", command=lambda: add_to_calculations("."),width=5, font=("Arial",14))
...
btn_equal=tk.Button(root, text="=", command=evaluate_calculations,width=5, font=("Arial",14))
